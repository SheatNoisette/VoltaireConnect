...
//List of all possible error -- very ugly we have to change it later
...
/*
  Fill a Tree Object with a sentence
*/
...
function fixSentence(sentence) {
    ...
    //Send a request to Language Tool in order to identify confirmed errors.
